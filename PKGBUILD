...
"
arch=('i686' 'x86_64')
depends=( 'glib2' 'libgee' 'cairo' 'gtk3' 'pango' 'gdk-pixbuf2' 'readline' 'atk' 'libx11' 'pandoc-static' 'curl' )
makedepends=( 'vala' 'glibc' 'glib2' 'libgee' 'readline' 'cairo' 'gtk3' 'gdk-pixbuf2' 'pango' 'atk' 'libx11' 'cmake' 'gettext' 'pkg-config' 'gcc' 'make' 'intltool' 'pandoc-static' 'bash-completion' )
build() {
