...
namespace AutoVala {
	public enum ConfigType { GLOBAL, VALA_BINARY, VALA_LIBRARY, BINARY, ICON, PIXMAP, PO, GLADE, DBUS_SERVICE, DBUS_CONFIG, DESKTOP, AUTOSTART,
		                     EOS_PLUG, SCHEME, DATA, DOC, INCLUDE, IGNORE, CUSTOM, DEFINE, MANPAGE, BASH_COMPLETION, SOURCE_DEPENDENCY,
		                     BINARY_DEPENDENCY, APPDATA, GRESOURCE, TRANSLATION, VAPIDIR, EXTERNAL, POLKIT, MIMETYPE }
